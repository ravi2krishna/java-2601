...
public class Student {
    ...
    public Student(int studentID, String studentName) {
        this(studentID, studentName, studentName, studentName, studentName);
    }

    // hover show only few details - studentID, studentName, studentGender
    // this() - constructor chaining
